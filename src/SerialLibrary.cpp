...
bool BaseCom::SetupPort() {
	...
	_co.ReadTotalTimeoutConstant = 100000;
...
bool BaseCom::openLinuxPort(const SerialPortInfo& portinfo) {
	...
	if (fcntl(_fdSerial, F_SETFL, FNDELAY) < 0)//������������ǰ��open������
	{
	...
	/*
	int ifcntl = fcntl(_fdSerial, F_SETFL, 0); //����
	if (ifcntl < 0)
	{
...
int ASynCom::Read(char* buf, int buf_len) {
	...
	return r_len;
#else
	return (int)readDataTty(_fdSerial, buf, 20, buf_len); //100 û�����ݾ͵ȴ�100����
#endif
